  ...
  const faqs = [
    {
      ...
      answer:
        "Project timelines vary based on scope, but most frontend projects take 2-4 weeks, while data analytics projects can range from 1-3 weeks depending on complexity.",
    },
    {
      question: "Do you work on both design and development?",
      answer:
        "Yes! I handle the complete process from UX research and design to frontend development and data analysis. This ensures consistency and optimal user experience.",
    },
    {
      question: "What technologies do you specialize in?",
      answer:
        "I specialize in React.js, Next.js, TypeScript for frontend development, and Python, SQL, Tableau for data analytics. I also use Figma for design work.",
    },
    {
      question: "Do you offer ongoing support after project completion?",
      answer:
        "Absolutely! I provide post-launch support, performance monitoring, and can help with updates and improvements based on user feedback and analytics.",
    },
  ];
        ...
        <div className="container-width">
          <div className="text-center space-y-6 fade-in">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Ready to create something amazing? I'd love to hear about your
              project and how we can bring your ideas to life.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-muted-foreground">
                  ...
                  interesting projects. Whether you need frontend development,
                  UI/UX design, or data analytics, I'm here to help bring your
                  ideas to life.
                </p>
              </div>
              ...
              <div className="card-elevated p-4 space-y-3">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h3 className="font-medium text-foreground">Resumes</h3>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  ...
                  >
                    <Button
                      size="sm"
                      className="w-full btn-ghost hover-glow"
                      variant="outline"
                    >
